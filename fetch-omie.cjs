...
const APP_KEY = process.env.OMIE_APP_KEY || process.env.OMIE_APP_KEY_MATRIZ;
const APP_SECRET = process.env.OMIE_APP_SECRET || process.env.OMIE_APP_SECRET_MATRIZ;
if (!APP_KEY || !APP_SECRET) {
  console.error('ERRO: defina OMIE_APP_KEY/OMIE_APP_SECRET (ou _MATRIZ) em .env');
  process.exit(1);
}
